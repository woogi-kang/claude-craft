...
_RESERVATION_UPDATE_COLUMNS = frozenset({
    "clinic_id", "clinic_name", "clinic_kakao_url",
...
class ReservationRepository:
    ...
    def init_db(self) -> None:
        """Create reservation tables and indexes."""
        conn = self._get_conn()
    ...
    def create_reservation(
        ...
        *,
        ...
        clinic_kakao_url: str | None = None,
        ...
        cursor = conn.execute(
            """INSERT INTO reservations
               (request_id, clinic_id, clinic_name, clinic_kakao_url,
                patient_name, patient_nationality, patient_age, patient_gender,
                patient_contact,
                procedure_name, preferred_dates, preferred_time, notes,
