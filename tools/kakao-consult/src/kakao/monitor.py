"""Message monitor -- polls KakaoTalk for new unread messages."""
...
class MessageMonitor:
    """Poll KakaoTalk chat list for unread messages.
    ...
    def poll(self) -> list[NewMessage]:
        ...
        try:
            ...
            badge_elements = self._device.resourceId(selectors.CHAT_ITEM_BADGE)  # type: ignore[attr-defined]
            ...
            for i in range(min(count, 10)):  # Max 10 per poll
                try:
                    ...
                    title_el = parent.child(resourceId=selectors.CHAT_ITEM_TITLE)
                    msg_el = parent.child(resourceId=selectors.CHAT_ITEM_MESSAGE)
