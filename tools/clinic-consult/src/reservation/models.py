...
CREATE TABLE IF NOT EXISTS reservations (
    ...
    contact_platform    TEXT    DEFAULT 'kakao',
...
ALTER TABLE reservations ADD COLUMN contact_platform TEXT DEFAULT 'kakao';
"""

MIGRATION_RENAME_KAKAO_URL = """\
ALTER TABLE reservations RENAME COLUMN clinic_kakao_url TO clinic_contact_url;
"""
