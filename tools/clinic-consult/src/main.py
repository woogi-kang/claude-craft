...
class PipelineRunner:
    ...
    def _lazy_init(self) -> None:
        ...
        from src.device.monitor import MessageMonitor
        ...
        self._sender = MessageSender(
            device,
            selectors=None,  # defaults to platform selectors
    ...
    async def run_once(self, *, dry_run: bool = False) -> PipelineRunResult:
        ...
        try:
            ...
            # Ensure messenger is in foreground and on chat list
            self._navigator.ensure_foreground()
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Clinic Consult Bot")
    parser.add_argument(
        "--once",
        action="store_true",
        default=False,
