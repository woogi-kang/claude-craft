"""Send messages in the current messenger chatroom.

Delivers text through the messenger input field with human-like
...
class MessageSender:
    """Type and send messages in the currently open chatroom.
    ...
    async def send(self, text: str) -> bool:
        ...
        try:
            ...
            input_field = self._device.resourceId(self._selectors.message_input)  # type: ignore[attr-defined]
            ...
            send_btn = self._device.resourceId(self._selectors.send_button)  # type: ignore[attr-defined]
