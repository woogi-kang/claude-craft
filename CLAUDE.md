...
| **💻 개발** | flutter-expert-agent | 27 | Flutter 앱 개발 (Clean Architecture + Riverpod 3 + TDD) |
...
│   ├── flutter-expert-agent-skills/ (27 skills + 6 references)
...
현대적인 Flutter 앱 개발을 위한 종합 Agent입니다. 27개 Skills + 6개 References로 구성:
...
| `.claude/skills/💻 개발/flutter-expert-agent-skills/` | Flutter Expert skills (27개 + 6 references) |
