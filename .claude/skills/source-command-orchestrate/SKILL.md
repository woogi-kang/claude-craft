...
description: "병렬 워크트리 오케스트레이션 — 여러 Codex 인스턴스를 동시에 실행"
---
...
4. Key considerations:
   ...
   - context_pack: path to `context-pack-gate` report or manifest, kept separate from task prose
