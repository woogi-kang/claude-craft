...
**Q1. 아이디어가 어느 정도 구체화되어 있나요?**
- 명확함 (한 줄로 설명 가능) → 바로 정리 시작
- 모호함 (여러 방향 가능) → "어떤 문제를 해결하고 싶으세요?"

**Q2. 해결하려는 문제가 본인의 경험에서 나온 건가요?**
- 본인 경험 → 구체적 상황 공유 요청
- 관찰/추측 → "타겟 사용자와 대화해본 적 있으세요?"

**Q3. 유사한 서비스를 사용해본 경험이 있나요?**
- 있음 → "어떤 점이 불만족스러웠나요?"
- 없음 → 경쟁사 조사 병행 제안
...
| 시점 | 확인 내용 | 사용자 프롬프트 |
|------|----------|----------------|
| 문제 정의 | 문제 구체성 | "이 문제를 겪는 구체적인 상황은?" |
| 솔루션 정의 | 핵심 기능 | "가장 중요한 기능 하나만 고르면?" |
| 타이밍 검토 | Why Now | "왜 지금 이 서비스가 필요한가요?" |
| 최종 확인 | Fit 검증 | "Problem-Solution Fit이 느껴지시나요?" |
