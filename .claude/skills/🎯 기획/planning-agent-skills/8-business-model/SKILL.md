...
**Q1. 수익 모델 유형이 결정되었나요?**
- 결정됨 → 해당 모델 상세 설계
- 미정 → "고객이 어떤 가치에 돈을 낼까요? (시간 절약, 매출 증가, 비용 절감)"

**Q2. 고객 획득 채널이 있나요?**
- 있음 → CAC 계산 진행
- 없음 → "첫 100명 고객을 어떻게 확보할 계획인가요?"

**Q3. 유사 서비스의 가격을 알고 있나요?**
- 알고 있음 → 벤치마크로 활용
- 모름 → 경쟁사 가격 조사 필요 안내
...
| 시점 | 확인 내용 | 사용자 프롬프트 |
|------|----------|----------------|
| LTV 계산 | 가정 검토 | "월 이탈률 가정이 현실적인가요?" |
| CAC 계산 | 채널 비용 | "광고비 외 고객 획득 비용은?" |
| LTV:CAC | 비율 검토 | "3:1 미만이면 어떻게 개선할까요?" |
| 손익분기 | 현실성 | "이 고객 수를 확보할 수 있나요?" |
