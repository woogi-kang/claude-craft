...
**Q2. GTM 전략 유형을 정했나요?**
- 정함 → 선택한 전략에 맞는 채널 설계
- 안 정함 → "Product-Led vs Sales-Led, 어떤 방식인가요?"

**Q3. 런칭 예산이 확정되었나요?**
- 확정됨 → 예산 기반 채널 믹스 설계
- 미확정 → "마케팅 예산 규모는 어느 정도인가요?"

### 의사결정 포인트

| 시점 | 확인 내용 | 사용자 프롬프트 |
|------|----------|----------------|
| 타겟 | ICP | "첫 100명 고객은 누구인가요?" |
| 메시지 | 차별화 | "경쟁사와 다른 우리만의 메시지는?" |
| 채널 | 집중 | "런칭 시 집중할 채널 Top 3는?" |
| 프로모션 | 오퍼 | "런칭 특별 프로모션이 있나요?" |
