...
**Q2. 투자 라운드가 정해졌나요?**
- 정해짐 → 라운드에 맞는 Traction 강조
- 미정 → "Pre-Seed, Seed, Series A 중 어디인가요?"

**Q3. Traction 데이터가 있나요?**
- 있음 → 데이터 기반 신뢰 구축
- 없음 → 비전과 팀 역량 중심 스토리
...
| 시점 | 확인 내용 | 사용자 프롬프트 |
|------|----------|----------------|
| One-liner | 핵심 | "한 문장으로 서비스를 설명하면?" |
| Problem | 공감 | "고객이 가장 아파하는 점은?" |
| Market | 규모 | "TAM/SAM/SOM 수치가 있나요?" |
| Ask | 요청 | "얼마를 요청하고 어디에 쓰나요?" |
