...
triggers:
  ...
  - "리서치 종합"
input:
  - 02-research/notebooklm-research-setup.md  # Deep Mode only
...
├─────────────────────────────────────────────────────────────┤
│                                                              │
│   76. NotebookLM Research → 딥 리서치 소스 수집 (Deep Mode)  │
...
- [ ] notebooklm-research-setup.md 완료 (Deep Mode인 경우)
- [ ] tam-sam-som.md 완료
...
**Q2. 시장 규모 데이터의 신뢰도는?**
- 높음: 공신력 있는 리서치 기관 데이터 또는 NotebookLM 딥 리서치 (20+ 소스 교차 검증)
- 중간: 다수의 2차 자료 교차 검증
- 낮음: 추정 기반 (WebSearch 단발 검색)
