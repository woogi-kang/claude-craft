...
> **78%가 숏폼으로 새 제품을 알게 됨** - 숏폼 카피는 필수!
...
hook_types:
  ...
  empathy:
    - "{pain_point}인 사람 손!"
    - "나만 {pain_point} 겪어?"
    - "{number}개인데 정리한 거 0개인 사람"

  provocative:
    - "이거 모르면 손해"
    - "{competitor} 쓰는 사람 보세요"
    - "이게 진짜 된다고?"
...
**템플릿 1: 문제-솔루션형**
```
[Hook] {pain_point}인 사람?

[Problem] 맨날 {old_way} 하느라 힘들잖아
         시간은 시간대로 쓰고

[Solution] 이제 {product}가 알아서 해줌
          [데모 화면]
          진짜 {benefit} 됨
...
**템플릿 2: Before-After형**
```
[Hook] {old_way} vs {new_way}

[Before] 전: {pain_situation}
        [Before 화면]

[After] 후: {ideal_situation}
       [After 화면]
...
| 플랫폼 | 최적 길이 | 훅 스타일 | 특징 |
|--------|----------|----------|------|
| TikTok | 15-30초 | 도발적, 트렌디 | 트렌드 사운드 필수 |
| Reels | 15-30초 | 감성적, 예쁜 | 비주얼 중요 |
| Shorts | 30-60초 | 정보성 | 가치 전달 |
