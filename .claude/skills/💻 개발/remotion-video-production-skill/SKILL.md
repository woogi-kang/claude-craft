...
description: "Remotion/FFmpeg 기반 영상 제작 스킬. React 기반 자막, 전환, 오디오, 데이터 시각화, prompt-to-video, OpenMontage 스타일 animated explainer, 로컬 TTS 내레이션, 영상 렌더링/검증이 필요할 때 사용한다."
metadata:
  version: 1.0.0
