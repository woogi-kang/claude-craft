...
현재 Codex-craft 하니스 설정을 종합 감사하고 스코어카드를 생성합니다.
...
- `GEMINI.md` → `AGENTS.md` symlink 유효
- `AGENTS.md` → `AGENTS.md` symlink 유효
...
## 출력 형식
```
=== Codex Craft Harness Audit ===

Category                    Score   Notes
AGENTS.md 품질              9/10    ✅ 간결, Rules 참조
