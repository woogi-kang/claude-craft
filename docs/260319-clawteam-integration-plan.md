...
```
.claude/agents/💻 개발/fastapi-agent.md
  → AgentDef(name="fastapi-agent", model="opus", category="개발")
...
```json
{
  ...
  "budget_cents": 500,
  "workers": [
    { "name": "Backend", "task": "...", "agent": "fastapi-agent" },
    { "name": "Frontend", "task": "...", "agent": "nextjs-agent" },
    { "name": "Tests", "task": "...", "agent": "tdd-loop-agent",
...
[[agents]]
name = "backend"
claude_craft_agent = "fastapi-agent"
role = "API 엔드포인트 구현"

[[agents]]
name = "frontend"
claude_craft_agent = "nextjs-agent"
role = "UI 컴포넌트 구현"

[[agents]]
name = "tester"
claude_craft_agent = "tdd-loop-agent"
role = "테스트 작성 및 실행"
